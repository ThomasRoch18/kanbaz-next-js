   ...
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-total-activity">01:27:12</td></tr>
      <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Steve</span>{" "}
          <span className="wd-last-name">Rogers</span></td>
      <td className="wd-login-id">001267561R</td>
      <td className="wd-section">S102</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2023-07-01</td>
      <td className="wd-total-activity">11:31:32</td></tr>
      <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
      ...
      <td className="wd-last-activity">2019-03-07</td>
